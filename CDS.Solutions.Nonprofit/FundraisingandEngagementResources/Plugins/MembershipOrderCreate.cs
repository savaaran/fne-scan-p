...
namespace Plugins
{
    ...
    public class MembershipOrderCreate : PluginBase
    {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            if (context.InputParameters.Contains("Target"))
            {
                if (context.InputParameters["Target"] is Entity)
                {
                    ...
                    {
                        queriedEntityRecord = service.Retrieve("msnfp_membershiporder", targetIncomingRecord.Id, GetColumnSet());
                    }
                ...
                {
                    queriedEntityRecord = service.Retrieve("msnfp_membershiporder", ((EntityReference)context.InputParameters["Target"]).Id, GetColumnSet());
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "MembershipOrder"; // Used for API calls
            ...
            if (apiUrl != string.Empty)
            {
                ...
                MSNFP_MembershipOrder jsonDataObj = new MSNFP_MembershipOrder();

                jsonDataObj.MembershipOrderId = (Guid)queriedEntityRecord["msnfp_membershiporderid"];
                ...
                // Get the Membership Category ID:
                if (queriedEntityRecord.Contains("msnfp_frommembershipid") && queriedEntityRecord["msnfp_frommembershipid"] != null)
                {
                    jsonDataObj.FromMembershipCategoryId = ((EntityReference)queriedEntityRecord["msnfp_frommembershipid"]).Id;
                    localContext.TracingService.Trace("Got msnfp_frommembershipid.");
                }
                else
                {
                    jsonDataObj.FromMembershipCategoryId = null;
                ...
                {
                    jsonDataObj.ToMembershipGroupId = ((EntityReference)queriedEntityRecord["msnfp_tomembershipgroupid"]).Id;
                    localContext.TracingService.Trace("Got msnfp_tomembershipgroupid.");
                }
                else
                {
                    jsonDataObj.ToMembershipGroupId = null;
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_MembershipOrder));

...
namespace Plugins
{
    public class ResponseCreate : PluginBase
    {
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "Response"; // Used for API calls
            ...
            if (apiUrl != string.Empty)
            {
                ...
                MSNFP_Response jsonDataObj = new MSNFP_Response();

                jsonDataObj.ResponseId = (Guid)queriedEntityRecord["msnfp_responseid"];
                ...
                else
                {
                    ...
                    {
                        jsonDataObj.Result = (string)queriedEntityRecord["msnfp_response"];
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_Response));

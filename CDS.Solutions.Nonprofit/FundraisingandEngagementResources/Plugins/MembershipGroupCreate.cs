...
namespace Plugins
{
    ...
    public class MembershipGroupCreate : PluginBase
    {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            if (context.InputParameters.Contains("Target"))
            {
                if (context.InputParameters["Target"] is Entity)
                {
                    ...
                    {
                        queriedEntityRecord = service.Retrieve("msnfp_membershipgroup", targetIncomingRecord.Id, GetColumnSet());
                    }
                ...
                {
                    queriedEntityRecord = service.Retrieve("msnfp_membershipgroup", ((EntityReference)context.InputParameters["Target"]).Id, GetColumnSet());
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "MembershipGroup"; // Used for API calls
            ...
            if (apiUrl != string.Empty)
            {
                ...
                MSNFP_MembershipGroup jsonDataObj = new MSNFP_MembershipGroup();

                jsonDataObj.MembershipGroupId = (Guid)queriedEntityRecord["msnfp_membershipgroupid"];
                ...
                {
                    jsonDataObj.GroupName = (string)queriedEntityRecord["msnfp_groupname"];
                    localContext.TracingService.Trace("Got msnfp_groupname.");
                }
                else
                {
                    jsonDataObj.GroupName = null;
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_MembershipGroup));

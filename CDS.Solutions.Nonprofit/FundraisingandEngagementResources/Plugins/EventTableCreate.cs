...
namespace Plugins
{
    ...
    public class EventTableCreate : PluginBase
    {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            if (context.InputParameters.Contains("Target"))
            {
                if (context.InputParameters["Target"] is Entity)
                {
                    ...
                    {
                        queriedEntityRecord = service.Retrieve("msnfp_eventtables", targetIncomingRecord.Id, GetColumnSet());
                    }
                ...
                {
                    queriedEntityRecord = service.Retrieve("msnfp_eventtables", ((EntityReference)context.InputParameters["Target"]).Id, GetColumnSet());
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "EventTable"; // Used for API calls
            ...
            {                
                ...
                MSNFP_EventTable jsonDataObj = new MSNFP_EventTable();

                jsonDataObj.eventtableid = (Guid)queriedEntityRecord["msnfp_eventtablesid"];
                ...
                {
                    jsonDataObj.tablecapacity = (int)queriedEntityRecord["msnfp_tablecapacity"];
                    localContext.TracingService.Trace("Got msnfp_tablecapacity");
                }
                else
                {
                    jsonDataObj.tablecapacity = null;
                ...
                {
                    jsonDataObj.tablenumber = (string)queriedEntityRecord["msnfp_tablenumber"];
                    localContext.TracingService.Trace("Got msnfp_tablenumber.");
                }
                else
                {
                    jsonDataObj.tablenumber = null;
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_EventTable));

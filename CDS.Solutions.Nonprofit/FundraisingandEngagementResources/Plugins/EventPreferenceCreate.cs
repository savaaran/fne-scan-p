...
namespace Plugins
{
    ...
    public class EventPreferenceCreate : PluginBase
    {
            ...
            if (context.InputParameters.Contains("Target"))
            {
                if (context.InputParameters["Target"] is Entity)
                {
                    ...
                    if (messageName == "Update")
                        queriedEntityRecord = service.Retrieve("msnfp_eventpreference", targetIncomingRecord.Id, GetColumnSet());
                ...
                {
                    queriedEntityRecord = service.Retrieve("msnfp_eventpreference", ((EntityReference)context.InputParameters["Target"]).Id, GetColumnSet());
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "EventPreference"; // Used for API calls
            ...
            if (apiUrl != string.Empty)
            {
                ...
                MSNFP_EventPreference jsonDataObj = new MSNFP_EventPreference();

                jsonDataObj.eventpreferenceid = (Guid)queriedEntityRecord["msnfp_eventpreferenceid"];
                ...
                {
                    jsonDataObj.preferenceid = ((EntityReference)queriedEntityRecord["msnfp_preferenceid"]).Id;
                    localContext.TracingService.Trace("Got msnfp_preferenceid");
                }
                else
                {
                    jsonDataObj.preferenceid = null;
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_EventPreference));

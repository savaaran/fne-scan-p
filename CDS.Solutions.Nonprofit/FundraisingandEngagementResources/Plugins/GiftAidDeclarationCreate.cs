...
namespace Plugins
{
    ...
    public class GiftAidDeclarationCreate : PluginBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GiftAidDeclarationCreate"/> class.
        /// </summary>
        ...
        private void AddOrUpdateThisRecordWithAzure(Entity queriedEntityRecord, Entity configurationRecord, LocalPluginContext localContext, IOrganizationService service, IPluginExecutionContext context)
        {
            ...
            string messageName = context.MessageName;
            string entityName = "GiftAidDeclaration"; // Used for API calls
            ...
            if (apiUrl != string.Empty)
            {
                ...
                MSNFP_GiftAidDeclaration jsonDataObj = new MSNFP_GiftAidDeclaration();

                jsonDataObj.GiftAidDeclarationId = (Guid)queriedEntityRecord["msnfp_giftaiddeclarationid"];
                ...
                {
                    jsonDataObj.DeclarationDate = (DateTime)queriedEntityRecord["msnfp_declarationdate"];
                    localContext.TracingService.Trace("Got msnfp_declarationdate.");
                }
                else
                {
                    jsonDataObj.DeclarationDate = null;
                ...
                {
                    jsonDataObj.DeclarationDelivered = ((OptionSetValue)queriedEntityRecord["msnfp_declarationdelivered"]).Value;
                    localContext.TracingService.Trace("Got msnfp_declarationdelivered.");
                }
                else
                {
                    jsonDataObj.DeclarationDelivered = null;
                ...
                {
                    jsonDataObj.GiftAidDeclarationHtml = (string)queriedEntityRecord["msnfp_giftaiddeclarationhtml"];
                    localContext.TracingService.Trace("Got msnfp_giftaiddeclarationhtml.");
                }
                else
                {
                    jsonDataObj.GiftAidDeclarationHtml = null;
                ...
                if (messageName == "Create")
                {
                    jsonDataObj.Updated = DateTime.UtcNow;
                }
                else if (queriedEntityRecord.Contains("msnfp_updated") && queriedEntityRecord["msnfp_updated"] != null)
                {
                    jsonDataObj.Updated = (DateTime)queriedEntityRecord["msnfp_updated"];
                }
                else
                {
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MSNFP_GiftAidDeclaration));
